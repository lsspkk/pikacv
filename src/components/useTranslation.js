...
const fi = {
  ...
  introduction: 'Tee pika cv syöttämällä tiedot, kokemus taidot ja opinnot. Säädä ulkoasu ja tee PDF-tiedosto selaimen tulostustoiminnolla. Tietojasi ei lähetetä automaattisesti minnekään. Voit itse halutessasi tallettaa ne käyttämäsi koneen selaimen muistiin tai tiedostoon.',
  label: 'Avainsanat',
  layout: 'Ulkoasu',
  level: 'Taso',
